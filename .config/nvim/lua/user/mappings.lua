...
map('n', '<leader>dc', dap.continue, opts("Debugger continue"))
map('n', '<leader>dj', dap.step_over, opts("Debugger step over"))
map('n', '<leader>dk', dap.step_out, opts("Debugger step out"))
map('n', '<leader>dl', dap.step_into, opts("Debugger step into"))
map('n', '<leader>db', dap.toggle_breakpoint, opts("Debugger toggle breakpoint"))
map('n', '<leader>dt', "<cmd>lua vim.cmd('RustLsp testables')<cr>", opts("Debugger run rust tests"))
map('n', '<leader>dx', function() dap.terminate() dapui.close() end, opts("Debugger terminate"))
